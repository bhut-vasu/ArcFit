        ...
        <div className="container page-padding py-[5rem]">
          ...
          <div className="mt-[10rem]">
            <div className="grid grid-cols-2 grid-rows-2 w-full min620:grid-cols-1">
              <div className="w-full bg-white h-[43rem] flex flex-col justify-start items-center px-[100px] min800:px-[10px]">
                <img src={Target} alt="target_img" className="w-[9rem]" />
                <h2 className="text-[36px] font-bold mt-3">Our Mission</h2>
                <p className="text-[16px] font-medium text-[#646464] mt-5">
                  <b> Purpose : </b>Inspire a commitment to lifelong health,
                  encouraging members to see fitness as a sustainable and
                  enjoyable part of their journey.
                </p>
                <p className="text-[16px] font-medium text-[#646464] mt-5">
                  <b>Commitment : </b>Promise responsive and attentive customer
                  support, addressing member inquiries, feedback, and concerns
              ...
              <div className="w-full bg-white h-[43rem] flex flex-col justify-start items-center px-[100px] min800:px-[10px]">
                ...
                <h2 className="text-[36px] font-bold mt-3">Our Vision</h2>
                <p className="text-[16px] font-medium text-[#646464] mt-5">
                  <b>Future Aspirations :</b> Strive to continously innovate in
                  the fitness industry and workout methodologies to provide members with the best
                  possible fitness experience.
                </p>
                <p className="text-[16px] font-medium text-[#646464] mt-5">
                  <b>Values : </b>Uphold the highest standards of integrity in
                  all aspects of our operations, ensuring transparency, honesty,
                  and accountability.
                </p>
              </div>
            </div>
